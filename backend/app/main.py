...
from app.modules.audit_policies.router import router as audit_policies_router
...
app.include_router(audit_policies_router, prefix="/api/v1/audit_policies", tags=["audit_policies"])
