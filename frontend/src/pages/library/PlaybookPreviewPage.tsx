        ...
        <div style={{ padding: '24px' }}>
            <style>{`
                ...
                .docx-wrapper > section.docx {
                    ...
                    border: 1px solid rgba(198,198,205,0.4) !important;
            ...
            <Card bodyStyle={{ padding: 0 }} style={{ borderRadius: '8px', border: '1px solid rgba(198,198,205,0.4)', boxShadow: '0 1px 2px rgba(0,0,0,0.03)' }}>
                {loading && (
