...
const ContractDetailPageContent: React.FC = () => {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            setIsAnalyzing(true);
            await contractService.analyzeContract(id, false, fullContextMode);
    ...
    return (
        <div className="contract-detail-page" style={{ padding: '0 0 64px 0', maxWidth: '1440px', margin: '0 auto' }}>
            {/* Header Actions */}
            <div className="contract-detail-header" style={{ marginBottom: '32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px', padding: '24px 24px 0' }}>
                <Space align="center" size="middle">
                    <Button type="text" icon={<ArrowLeftOutlined />} onClick={() => navigate('/contracts')} style={{ paddingLeft: 0, color: '#667085', fontWeight: 500 }}>
                        Back
                    </Button>
                    <h1 style={{ fontFamily: 'Inter, sans-serif', fontSize: '32px', fontWeight: 500, color: '#24303a', margin: 0, letterSpacing: '-0.02em', lineHeight: '1.2' }}>{contract.name}</h1>
                    <span style={{
                        color: getBadgeColor(contract.status),
                        backgroundColor: `${getBadgeColor(contract.status)}1A`,
                        padding: '4px 8px',
                        borderRadius: '4px',
                        fontSize: '12px',
                        fontWeight: 600,
                        ...
                        {getStatusText(contract.status as any)}
                    </span>
                    <span style={{ fontSize: '12px', color: '#24303a', background: '#d3e3fd', padding: '4px 8px', borderRadius: '4px', fontWeight: 600 }}>
                        Ver: {contract.currentVersion}
                    </span>
                ...
                <Space>
                    <Button icon={<HistoryOutlined />} style={{ borderRadius: '4px' }} onClick={() => {
                    ...
                    <Tooltip title={(!contract.versions || contract.versions.length < 2) ? 'Cần ít nhất 2 phiên bản để so sánh (áp dụng AI Fix để tạo phiên bản mới)' : ''}>
                        <Button
                            style={{ borderRadius: '4px', borderColor: '#d9d9d9', color: '#111827' }}
                ...
                items={[
                    {
                        ...
                        children: (
                            <>
                                ...
                                <Card title={<span style={{ fontFamily: 'Inter, sans-serif', fontSize: '20px', fontWeight: 500, color: '#111827' }}>Agreement Information</span>} bordered={false} className="bg-surface-container-lowest shadow-sm" style={{ borderRadius: '4px', border: '1px solid rgba(198, 198, 205, 0.4)', marginBottom: '24px' }} bodyStyle={{ padding: '0' }}>
                                    <Table
                                        dataSource={[
                                        ...
                                        size="small"
                                    >
                                        <Table.Column dataIndex="field" key="field" render={(text: string) => (
                                            <span style={{ color: '#111827', fontWeight: 500 }}>{text}</span>
                                        )} />
                                        <Table.Column dataIndex="value" key="value" render={(text: string) => <span style={{ color: '#667085' }}>{text}</span>} />
                                    </Table>
                                </Card>
                                ...
                                {(() => {
                                    ...
                                    return (
                                        <Card
                                            title={
                                                <div className="risk-card-header" style={{ padding: '24px' }}>
                                                    <Space>
                                                        <span style={{ fontFamily: 'Inter, sans-serif', fontSize: '20px', fontWeight: 500, color: '#111827' }}>AI Risk Analysis Results</span>
                                                        <span style={{ background: '#ffdad6', color: '#ba1a1a', padding: '2px 8px', borderRadius: '4px', fontSize: '12px', fontWeight: 600 }}>{filteredRisks.length} Risks Detected</span>
                                                    </Space>
                                                    <Space>
                                                        {selectedRowKeys.length > 0 && (
                                                            <Space>
                                            ...
                                            style={{ borderRadius: '4px', border: '1px solid rgba(198, 198, 205, 0.4)' }}
                                            bodyStyle={{ padding: 0 }}
                                            bordered={false}
