    ...
    return (
        <Layout style={{ height: '100vh', flexDirection: 'column' }}>
            ...
            <div style={{
                padding: '24px 32px',
                background: '#ffffff',
                borderBottom: '1px solid rgba(198, 198, 205, 0.4)',
                display: 'flex',
                justifyContent: 'space-between',
                alignItems: 'center'
            }}>
                <Space align="center" size="middle">
                    <Button type="text" icon={<ArrowLeftOutlined />} onClick={() => navigate(`/contracts/${id}`)} style={{ paddingLeft: 0, color: '#667085', fontWeight: 500 }}>
                        Cancel
                    </Button>
                    <div>
                        <h1 style={{ fontFamily: 'Inter, sans-serif', fontSize: '28px', fontWeight: 500, color: '#24303a', margin: 0, letterSpacing: '-0.02em', lineHeight: '1.2' }}>Review & Edit: {contract?.name || 'Loading...'}</h1>
                        <Text style={{ color: '#667085' }}>Create a new version by manually editing the text</Text>
                    </div>
                </Space>
            ...
            <Layout style={{ flex: 1, overflow: 'hidden' }}>
                ...
                <Sider width={400} theme="light" style={{ borderLeft: '1px solid rgba(198, 198, 205, 0.4)', padding: '24px', overflowY: 'auto', background: '#f8f9fa' }}>
                    <h2 style={{ fontFamily: 'Inter, sans-serif', fontSize: '20px', fontWeight: 500, color: '#111827', margin: '0 0 16px 0' }}>
                        <WarningOutlined style={{ marginRight: 8, color: '#f59e0b' }} />
                        Selected Issues ({selectedRisks.length})
                    </h2>
                    <Divider style={{ margin: '12px 0', borderColor: 'rgba(198, 198, 205, 0.4)' }} />
                    ...
                    <List
                        ...
                        renderItem={risk => (
                            <Card
                                ...
                                style={{
                                    marginBottom: 16,
                                    borderLeft: `4px solid ${risk.risk_type === 'recommendation' ? '#f59e0b' : '#3b82f6'}`,
                                    borderTop: '1px solid rgba(198, 198, 205, 0.4)',
                                    borderRight: '1px solid rgba(198, 198, 205, 0.4)',
                                    borderBottom: '1px solid rgba(198, 198, 205, 0.4)',
                                    borderRadius: '4px',
                                    cursor: 'pointer',
                                    transition: 'all 0.3s',
                                ...
                                extra={
                                    <Space>
                                        <Tag color={
                                            risk.severity === 'high' ? '#ba1a1a' :
                                                risk.severity === 'medium' ? '#f59e0b' : '#10b981'
                                        } style={{ border: 'none', color: '#fff', borderRadius: '4px', fontWeight: 600 }}>
                                            {risk.severity?.toUpperCase() || 'UNKNOWN'}
                                        </Tag>
                                        {risk.risk_type === 'recommendation' ?
                                            <Tag color="orange" style={{ border: 'none', borderRadius: '4px' }}>Recommendation</Tag> :
                                            <Tag color="blue" style={{ border: 'none', borderRadius: '4px' }}>Modification</Tag>
                                        }
                                    </Space>
                                }
                            >
                                        ...
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                            ...
                                            {risk.risk_type !== 'recommendation' && (
                                                <Button
                                                    size="small"
                                                    type="primary"
                                                    style={{ background: '#10b981', borderColor: '#10b981', fontSize: '11px', height: '22px', borderRadius: '4px' }}
