...
docker rm -f documind_worker documind_backend documind_frontend 2>/dev/null || true
...
echo "   Backend:   http://$(hostname -I | awk '{print $1}'):8012/docs"
echo ""
